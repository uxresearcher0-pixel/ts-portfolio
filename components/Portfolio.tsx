  ...
  return <>
    ...
    <main id="main-content">
      <section id="home" className="hero" aria-labelledby="hero-title"><div className="container hero-grid"><div>
        <p className="availability"><span aria-hidden="true"/>{content.availability}</p><p className="eyebrow">{content.title}</p>
      ...
      </div><aside className="hero-card" aria-label="Professional summary"><p className="hero-card-label">At a glance</p><dl><div><dt>Focus</dt><dd>{content.focus}</dd></div><div><dt>Approach</dt><dd>{content.approach}</dd></div><div><dt>Based in</dt><dd>{content.location}</dd></div></dl><div className="visual-note" aria-hidden="true"><span>Research</span><span>Design</span><span>Validate</span></div></aside></div></section>
